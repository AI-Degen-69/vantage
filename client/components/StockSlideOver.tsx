      ...
      >
        ...
        <div className="sticky top-0 bg-card border-b border-border z-10">
          <div className="flex items-center justify-between px-5 py-4">
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-lg hover:bg-accent transition-colors text-foreground/80 hover:text-foreground"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="px-5 py-4 space-y-5">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-16">
              <Loader2 className="w-6 h-6 animate-spin text-chart-blue mb-3" />
              <p className="text-xs text-foreground/80">Loading data...</p>
            </div>
          ) : isError ? (
            ...
            <>
                  ...
                  <div className="flex items-baseline justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        {quote.change != null && (
                          <span className={`text-sm font-semibold ${quote.change >= 0 ? "text-chart-green" : "text-chart-negative"}`}>
                            {quote.change >= 0 ? "+" : ""}
                        ...
                        {quote.changePercent != null && (
                          <span className={`text-xs font-semibold px-1.5 py-0.5 rounded ${
                            quote.changePercent >= 0 ? "bg-chart-green/20 text-chart-green" : "bg-chart-negative/20 text-chart-negative"
                          }`}>
                    ...
                    <div className="text-right">
                      {quote.afterHoursPrice != null && (
                        <div className="text-xs text-foreground/80">
                          ...
                          <span className={`ml-1 font-medium ${quote.afterHoursChange != null && quote.afterHoursChange >= 0 ? "text-chart-green" : "text-chart-negative"}`}>
                    ...
                    <div className="mt-3 pt-3 border-t border-border flex gap-4 text-xs">
                      {priceChange.ytd != null && (
                        <div>
                          ...
                          <span className={priceChange.ytd >= 0 ? "text-chart-green" : "text-chart-negative"}>
                      ...
                      {priceChange["1Y"] != null && (
                        <div>
                          ...
                          <span className={priceChange["1Y"] >= 0 ? "text-chart-green" : "text-chart-negative"}>
                      ...
                      {priceChange["3Y"] != null && (
                        <div>
                          ...
                          <span className={priceChange["3Y"] >= 0 ? "text-chart-green" : "text-chart-negative"}>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <div key={item.label} className="bg-muted/30 rounded px-3 py-2 border border-border/50">
                    ...
                    {quickStats.map((stat, idx) => (
                      <div key={idx}>
                        <button
                          ...
                          className="w-full flex items-center justify-between bg-muted/30 rounded px-3 py-2 border border-border/50 hover:bg-muted/50 transition-colors"
                        >
                        ...
                        {expandedStat === idx && stat.details && (
                          <div className="ml-3 mt-0.5 space-y-0.5 bg-muted/20 rounded px-3 py-2 border border-border/30">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-chart-blue/10 border border-chart-blue/30 text-primary hover:bg-primary/20 transition-all text-sm font-medium"
              >
